 ...
 * Templates Page
 *
 * Browse and use pre-built overlay and widget templates
 */
...
import { Search, Grid3x3, List, Eye, Sparkles, ArrowRight, Layers, Zap, Video } from 'lucide-react'
      ...
      <div className="relative bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 text-white py-20 px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="flex items-center gap-6 mt-6">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-white rounded-full"></div>
              <span className="text-purple-100">{filteredTemplates.length} Total Templates</span>
            </div>
          </div>
        </div>
      </div>
